...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "docker", autostart: false do |dkr|
    ...
    dkr.vm.provision "shell", inline: "echo 'Hello, World!'"
    dkr.vm.provision "shell", inline: "echo 'Now try logging in with: vagrant ssh'"

    # Uncomment this to try out if ansible provisioning works!
    # --------------------------------------------------------
